...
export RECOMP_D3D8_HOST_BUMP="${RECOMP_D3D8_HOST_BUMP:-1}"\
export RECOMP_D3D8_HOST_LIN32="${RECOMP_D3D8_HOST_LIN32:-1}"\
export RECOMP_D3D8_HOST_INLINE="${RECOMP_D3D8_HOST_INLINE:-1}"\
export RECOMP_D3D8_HOST_STENCIL="${RECOMP_D3D8_HOST_STENCIL:-1}"\
export RECOMP_D3D8_HOST_FOGTABLE="${RECOMP_D3D8_HOST_FOGTABLE:-1}"\
export RECOMP_D3D8_HOST_FAST_FETCH="${RECOMP_D3D8_HOST_FAST_FETCH:-1}"\
export RECOMP_D3D8_HOST_IB_CHUNK="${RECOMP_D3D8_HOST_IB_CHUNK:-1}"\
export RECOMP_D3D8_HOST_TEX_INDEX="${RECOMP_D3D8_HOST_TEX_INDEX:-1}"\
export RECOMP_D3D8_HOST_NO_CHECK="${RECOMP_D3D8_HOST_NO_CHECK:-1}"\
export RECOMP_SWM_WAKE="${RECOMP_SWM_WAKE:-1}"\
export RECOMP_PB_ELEM16_RUN="${RECOMP_PB_ELEM16_RUN:-1}"\
export RECOMP_METAL_ASYNC_HOST_VSH="${RECOMP_METAL_ASYNC_HOST_VSH:-1}"'
