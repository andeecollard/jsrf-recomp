...
LOG="$HOME/jsrf-build/preserved-logs/last-run_${STAMP}_TEXMODE-OFF-KEEP.log"
FBDIR="$HOME/jsrf-build/fbdump-${STAMP}-TEXMODE-OFF-KEEP"
...
echo "  log:    $LOG"
echo "  frames: $FBDIR"
echo "  DO NOT TOUCH THE CONTROLLER. It stops itself at t=55."
